                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="flex flex-col rounded-md shadow-lg px-3 py-2 pt-3">
                                                            ...
                                                            <div v-if="SelectedOne"
                                                                ...
                                                                <button  @click.prevent="issue()" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"
                                                           ...
                                                           <div>
                                                            <p class="text-xs text-red-600 mt-2"
                                                                ...
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.employeeName">{{ form.errors.employeeName
                                                                    }}
                                                                </p>
                                                           </div>
...
export default {
    ...
    methods: {
        issue() {
            this.form.patch(`/Breaking-dormancy/store-data/${this.form.SelectedId}`, { 
