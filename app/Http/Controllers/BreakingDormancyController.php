...
class BreakingDormancyController extends Controller
{
    //view Seed Extraction and its Activities
    public function BreakingDormancy()
    {
        $data = ParentActivity::with('childs')
            ->where('parent_number', 6)
            ->first();
        return Inertia::render('BreakingDormancy/BreakingDormancyActivities', [
            'data' => $data,
        ]);
    }
    ...
    public function ChildActivity($id)
    {
        ...
        return Inertia::render('BreakingDormancy/Table', [
            'childData' => $child,
    ...
    public function ViewStage($id)
    {
        ...
        return Inertia::render('BreakingDormancy/ActivityPage', [
            'Jobcard' => $jobCard,
